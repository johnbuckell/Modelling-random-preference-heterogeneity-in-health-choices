...
### Set core controls
apollo_control = list(
  modelName       = "SimDrugChoice2_MMNL_all_normal_WTPspace",
  modelDescr      = "SimDrugChoice2_MMNL_all_normal_WTPspace",
...
apollo_randCoeff = function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["b_branded"]]     = branded_mu     + branded_sigma     * draws_norm1_branded 
  randcoeff[["b_country_CH"]]  = country_CH_mu  + country_CH_sigma  * draws_norm1_CH  
  randcoeff[["b_country_DK"]]  = country_DK_mu  + country_DK_sigma  * draws_norm1_DK      
  randcoeff[["b_country_USA"]] = country_USA_mu + country_USA_sigma * draws_norm1_USA    
  randcoeff[["b_country_IND"]] = country_IND_mu + country_IND_sigma * draws_norm1_IND    
  randcoeff[["b_country_RUS"]] = country_RUS_mu + country_RUS_sigma * draws_norm1_RUS 
  randcoeff[["b_country_BRA"]] = country_BRA_mu + country_BRA_sigma * draws_norm1_BRA
  randcoeff[["b_char_fast"]]   = char_fast_mu   + char_fast_sigma   * draws_norm1_fast
  randcoeff[["b_char_double"]] = char_double_mu + char_double_sigma * draws_norm1_double
  randcoeff[["b_risk"]]        = risk_mu        + risk_sigma        * draws_norm1_risk
  randcoeff[["b_price"]]       = price_mu       + price_sigma       * draws_norm1_price
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[["alt1"]] = b_price*(price_1 + b_branded  * (brand_1=="Artemis"|brand_1=="Novum") 
  ...
  V[["alt2"]] = b_price*(price_2 + b_branded  * (brand_1=="Artemis"|brand_1=="Novum") 
  ...
  V[["alt3"]] = b_price*(price_3 + b_unbranded *(brand_3=="BestValue"|brand_3=="Supermarket"|brand_3=="PainAway") 
  ...
  V[["alt4"]] = b_price*(price_4 + b_unbranded*(brand_4=="BestValue"|brand_4=="Supermarket"|brand_4=="PainAway") 

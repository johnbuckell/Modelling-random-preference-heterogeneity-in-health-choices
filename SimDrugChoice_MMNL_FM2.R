...
### Set core controls
apollo_control = list(
  modelName       = "SimDrugChoice2_MMNL_FM2",
  modelDescr      = "SimDrugChoice2_MMNL_FM2",
...
apollo_beta = c(
  ...
  country_CH_sigma2 =-0,
  country_DK_sigma2 =-0,
  country_USA_sigma2 =0,
  country_IND_sigma2 =0,
  country_RUS_sigma2 =-0,
  country_BRA_sigma2 =0,
  char_fast_sigma2 =-0,
  char_double_sigma2 =-0,
  risk_sigma2 =0,
  price_sigma2 =0
...
randcoeff[["b_branded"]]=branded_mu+branded_sigma*draws_norm1_branded +branded_sigma2*draws_norm1_branded^2
randcoeff[["b_country_CH"]]=country_CH_mu+country_CH_sigma*draws_norm1_CH +country_CH_sigma2*draws_norm1_CH^2
randcoeff[["b_country_DK"]]=country_DK_mu+country_DK_sigma*draws_norm1_DK +country_DK_sigma2*draws_norm1_DK^2
randcoeff[["b_country_USA"]]=country_USA_mu+country_USA_sigma*draws_norm1_USA +country_USA_sigma2*draws_norm1_USA^2
randcoeff[["b_country_IND"]]=country_IND_mu+country_IND_sigma*draws_norm1_IND +country_IND_sigma2*draws_norm1_IND^2
randcoeff[["b_country_RUS"]]=country_RUS_mu+country_RUS_sigma*draws_norm1_RUS +country_RUS_sigma2*draws_norm1_RUS^2
randcoeff[["b_country_BRA"]]=country_BRA_mu+country_BRA_sigma*draws_norm1_BRA +country_BRA_sigma2*draws_norm1_BRA^2
randcoeff[["b_char_fast"]]=char_fast_mu+char_fast_sigma*draws_norm1_fast +char_fast_sigma2*draws_norm1_fast^2
randcoeff[["b_char_double"]]=char_double_mu+char_double_sigma*draws_norm1_double +char_double_sigma2*draws_norm1_double^2
randcoeff[["b_risk"]]=risk_mu+risk_sigma*draws_norm1_risk +risk_sigma2*draws_norm1_risk^2
randcoeff[["b_price"]]=price_mu+price_sigma*draws_norm1_price +price_sigma2*draws_norm1_price^2
...
rm(df1,df2)
names(df)[1]<- "idd"
names(df)[2]<- "avgLL_FM2"

setwd("J:/Model Averaging/Analysis/Empirical analysis/Tobacco choices")
write.csv(df,"SimDrugChoice2_MMNL_FM2_LL.csv", row.names=FALSE)
